            ...
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription>
                    {hasProducts ? 'Add another product' : 'Create your first product'}
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-500 mt-2">
              {hasProducts ? `${totalProducts} product${totalProducts !== 1 ? 's' : ''} in catalog` : 'Add your first product'}
            </p>
          </CardContent>
        </Card>
      </div>

      {/* Getting Started Guide - Only show if no products */}
      {!hasProducts && (
        <Card>
          <CardHeader>
